...
struct CurrentTimeMarker: View {
    ...
    private var xPosition: CGFloat {
        TimelinePositionHelper.positionForTime(hour: currentHour, minute: currentMinute, width: width)
    }
...
struct DropLineIndicator: View {
    ...
    private var xPosition: CGFloat {
        ...
        return TimelinePositionHelper.positionForTime(hour: targetTime.hour, minute: targetTime.minute, width: width)
    }
...
struct DropTimeBadge: View {
    ...
    private var xPosition: CGFloat {
        TimelinePositionHelper.positionForTime(hour: targetTime.hour, minute: targetTime.minute, width: width)
    }
